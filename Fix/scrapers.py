...
import itertools, random, os, cchardet, lxml, traceback, html, re
...
def CMSoupScraper(url, soup):
    ...
    try:
        ...
        out = [game, item, expansion, number, name, priceToFloat(allPrices[0]), priceToFloat(allPrices[1]), priceToFloat(allPrices[2]), priceToFloat(allPrices[3]), priceToFloat(allPrices[4])]
